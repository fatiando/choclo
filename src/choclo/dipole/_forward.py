...
def magnetic_field(
    ...
    .. note::
        ...
        Use this function when all the three component of the magnetic field
    ...
    b_e, b_n, b_u : float
        ...
        by the dipole at the observation point in :math:`\text{T}`.

    Notes
    -----
    The magnetic field vector :math:`\mathbf{B}` at the observation point
    :math:`\mathbf{p} = (x_p, y_p, z_p)` generated by a single dipole located
    at :math:`\mathbf{q} = (x_q, y_q, z_q)` and magnetic moment
    :math:`\mathbf{m}=(m_x, m_y, m_z)` is
    ...
    in which :math:`\mathbf{r} = \mathbf{p} - \mathbf{q}`,
    :math:`\lVert \cdot \rVert` refers to the :math:`L_2` norm, and
    :math:`\mu_0` is the vacuum magnetic permeability.
...
def magnetic_e(
    ...
    Returns the easting component of the magnetic field by a single dipole at
    a single computation point.
    ...
    b_e : float
        ...
        at the observation point in :math:`\text{T}`.

    Notes
    -----
    The easting component :math:`B_x(\mathbf{p})` of the magnetic field
    :math:`\mathbf{B}` at the observation point :math:`\mathbf{p} = (x_p, y_p,
    z_p)` generated by a single dipole located at :math:`\mathbf{q} = (x_q,
    y_q, z_q)` and magnetic moment :math:`\mathbf{m}=(m_x, m_y, m_z)` is
    ...
    .. math::
        ...
        B_x(\mathbf{p}) =
            ...
            \left[
            \frac{
                3 (\mathbf{m} \cdot \mathbf{r}) (x_p - x_q)
            }{
                \lVert r \rVert^5
            }
            -
...
def magnetic_n(
    ...
    Returns the northing component of the magnetic field by a single dipole at
    a single computation point.
    ...
    -------
    b_n : float
        Northing component of the magnetic field generated by the dipole at the
        observation point in :math:`\text{T}`.

    Notes
    -----
    The northing component :math:`B_y(\mathbf{p})` of the magnetic field
    :math:`\mathbf{B}` at the observation point :math:`\mathbf{p} = (x_p, y_p,
    z_p)` generated by a single dipole located at :math:`\mathbf{q} = (x_q,
    y_q, z_q)` and magnetic moment :math:`\mathbf{m}=(m_x, m_y, m_z)` is
    ...
    .. math::
        ...
        B_y(\mathbf{p}) =
            ...
            \left[
            \frac{
                3 (\mathbf{m} \cdot \mathbf{r}) (y_p - y_q)
            }{
                \lVert r \rVert^5
            }
            -
...
def magnetic_u(
    ...
    Returns the upward component of the magnetic field by a single dipole at
    a single computation point.
    ...
    -------
    b_u : float
        Upward component of the magnetic field generated by the dipole at the
        observation point in :math:`\text{T}`.

    Notes
    -----
    The upward component :math:`B_z(\mathbf{p})` of the magnetic field
    :math:`\mathbf{B}` at the observation point :math:`\mathbf{p} = (x_p, y_p,
    z_p)` generated by a single dipole located at :math:`\mathbf{q} = (x_q,
    y_q, z_q)` and magnetic moment :math:`\mathbf{m}=(m_x, m_y, m_z)` is
    ...
    .. math::
        ...
        B_z(\mathbf{p}) =
            ...
            \left[
            \frac{
                3 (\mathbf{m} \cdot \mathbf{r}) (z_p - z_q)
            }{
                \lVert r \rVert^5
            }
            -
